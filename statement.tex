...
\usepackage[left=1in, right=1in, top=0.4in, bottom=1in]{geometry}
\begin{document}
...
a graduate-level research project, a project I longed to work on, our mapping
tricycle. The tricycle system begins by taking a series of planar LIDAR scans.
From the aggregated scans, we segment out pole-like landmarks such as street
signs, lamp posts, and parking meters, and assign each landmark a GPS
...
SLAM. The work I have completed as of December 2014 has even been incorporated
as a section in our latest aforementioned journal submission. I am beginning to
