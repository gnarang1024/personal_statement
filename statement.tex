...
\begin{document}
\author{armon.shariati@gmail.com}
\title{Armon Shariati}
\date{}
\maketitle
...
Brett Browning developing vision based large-scale mining robots, I would
always be able to draw inspiration from the work Professor Howie Choset and his
team have produced on robust locomotion of non-conventional robot platforms,
simply because of proximity. The education CMU has to offer me is only
available at less than a handful of places on the planet. Not only can I
understand what a privilege it would be to a part of the community, but I would
